...
f = TFile.Open("/hepstore/sfarry/GridOutput/2609/GhostRate.30000000.MU.MC2016.root")
...
outputFile = TFile("/user2/sfarry/workspaces/ghosts/tuples/ghostrate_mc2016_ldst.root", "RECREATE")
pt.save()
eta.save()
chi2ndof.save()
ghostprob.save()

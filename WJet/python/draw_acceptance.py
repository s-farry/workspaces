...
o = Plot([f.Get('ETA_nlo_acc_plus'), f.Get('ETA_nlo_acc_minus')])
...
o.plots = [f.Get('Jet_ETA_nlo_acc_plus'), f.Get('Jet_ETA_nlo_acc_minus')]
o.setProp('filename', 'wj_acc_etaj')
o.setProp('xlabel', '#eta^{j}')
o.drawROOT()

o.plots = [f.Get('Jet_PT_nlo_acc_plus'), f.Get('Jet_PT_nlo_acc_minus')]

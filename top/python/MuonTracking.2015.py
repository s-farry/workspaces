...
f = TFile.Open('root://hepgrid11.ph.liv.ac.uk///dpm/ph.liv.ac.uk/home/lhcb/Run2Effs/MuonTracking_WLine.MU.2015.root')
g = TFile.Open('root://hepgrid11.ph.liv.ac.uk///dpm/ph.liv.ac.uk/home/lhcb/Run2Effs/MuonTracking_WLine.MD.2015.root')
...
def makeMuonTracking2015(name, selcut, passcut):
    ...
    MuonTracking2015MagUpMuMinus.Run()
    ...
    MuonTracking2015MagUpMuPlus.Run()
    MuonTracking2015MagUpMuPlus.SaveToFile()
    
    MuonTracking2015MagDownMuMinus.AddTree(v)
    ...
    MuonTracking2015MagDownMuMinus.Run()
    MuonTracking2015MagDownMuMinus.SaveToFile()
    
    MuonTracking2015MagDownMuPlus.AddTree(w)
    ...
    MuonTracking2015MagDownMuPlus.Run()

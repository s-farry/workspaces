...
receff_mupem.AddTree(t)
receff_mupem.AddTree(u)
receff_mupem.AddTree(v)
receff_mupem.AddTree(w)
...
receff_mumep.AddTree(t)
receff_mumep.AddTree(u)
receff_mumep.AddTree(v)
receff_mumep.AddTree(w)
...
seleff.SetPassCut(iso + ip + jettag)
seleff.AddTrees([x,y,z,a])

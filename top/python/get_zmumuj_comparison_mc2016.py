...
run1jet.Run()
run1jet.SaveToFile(loc + '/run1zjet_mc2016.root')
...
hltjet.Run()
hltjet.SaveToFile(loc + '/hltzjet_mc2016.root')
...
turbojet.Run()
turbojet.SaveToFile(loc + '/turbozjet_mc2016.root')
...
run11jet.Run()
run11jet.SaveToFile(loc + '/run1z1jet_mc2016.root')
...
hlt1jet.Run()
hlt1jet.SaveToFile(loc + '/hltz1jet_mc2016.root')
...
turbo1jet.Run()
turbo1jet.SaveToFile(loc + '/turboz1jet_mc2016.root')
...
run1fit.FitIt("MLLQ")
run1fit.SaveToFile(loc+"/run1zjetres_mc2016.root")
...
hltfit.FitIt("MLLQ")
hltfit.SaveToFile(loc+"/hltzjetres_mc2016.root")
...
turbofit.FitIt("MLLQ")
turbofit.SaveToFile(loc+"/turbozjetres_mc2016.root")
...
for p in plots:
    ...
    d.setProp('filename', 'zmumuj_'+p.name+'_mc2016.pdf')
    ...
    d.setProp('colors', ['red','black','blue'])
    d.setProp('location', '/user2/sfarry/workspaces/top/figures')
    d.setProp('filename', 'zmumu1j_'+p.name+'_mc2016.pdf')
    d.setProp('markerstyles', 20)
    d.setProp('leglims', [0.65, 0.7, 0.9, 0.9])
    if hasattr(p, 'shiftlegx'): d.ShiftLegX(p.shiftlegx)
    if hasattr(p, 'shiftlegy'): d.ShiftLegY(p.shiftlegy)
...
for p in ('ptj10', 'etaj10'):
    ...
    d.setProp('colors', ['red','black','blue'])
    d.setProp('location', '/user2/sfarry/workspaces/top/figures')
    d.setProp('filename', 'zjres_'+p+'_mc2016.pdf')
    d.setProp('markerstyles', 20)
...
d.setProp('colors', ['red', 'black', 'blue'])
d.setProp('location', '/user2/sfarry/workspaces/top/figures')
d.setProp('filename', 'zjbalance_mc2016.pdf')
d.setProp('markerstyles', 20)
d.setProp('leglims', [0.65, 0.7, 0.9, 0.9])

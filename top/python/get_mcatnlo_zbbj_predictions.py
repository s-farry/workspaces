...
ttf   = TFile.Open("/hepstore/sfarry/aMCatNLO/Zbbj/Events/Zbbj_amcatnlo_8tev.root")
t     = ttf.Get("tree")
...
zbb = get_templates('zbbj_8tev_amcatnlo', t)
zbb_recoiljet = get_templates('zbbj_recoiljet_8tev_amcatnlo', t, selections = [fwdfid + fwdrecoiljet, bwdfid+bwdrecoiljet])
zbb_partons = get_templates('zbbj_partons_8tev_amcatnlo', t, selections = [fwdparton, bwdparton], vars2use = fwdvars_partons)
...
acc = ratio_details('acc', zbb_recoiljet_out['bjet1_eta'], [zbb_recoiljet_out['bjet1_eta_Scale'+str(i)] for i in range(1,7)],
                          zbb_out['bjet1_eta'], [zbb_out['bjet1_eta_Scale'+str(i)] for i in range(1,7)],
...
output = TFile("/user2/sfarry/workspaces/top/tuples/zbbj_8tev_amcatnlo_predictions.root", "RECREATE")
bjet1_pt.write()
bjet1_eta.write()
bjet2_pt.write()
bjet2_eta.write()

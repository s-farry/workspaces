...
zmumuj_mc2016_tag_t = Template("zmumuj_mc2016_tag")
zmumuj_mc2016_tag_t.SetSelCut(zmumu_selection + zmumu_jet)
zmumuj_mc2016_tag_t.AddTrees(zmumuj_mc2016.trees())
zmumuj_mc2016_tag_t.AddVars(zvars)
zmumuj_mc2016_tag_t.Run()
zmumuj_mc2016_tag_t.Scale(zmumuj_sf)
zmumuj_mc2016_tag_t.SaveToFile("/user2/sfarry/workspaces/top/tuples/zmumuj_mc2016_tag.root")

ztautauj_mc2016_tag_t = Template("ztautauj_mc2016_tag")
ztautauj_mc2016_tag_t.SetSelCut(trigger + selection + jet )
ztautauj_mc2016_tag_t.AddTrees(ztautau_mc2016.trees())
ztautauj_mc2016_tag_t.AddVars(vars)
ztautauj_mc2016_tag_t.Run()
ztautauj_mc2016_tag_t.Scale(ztautauj_sf)
ztautauj_mc2016_tag_t.SaveToFile("/user2/sfarry/workspaces/top/tuples/ztautauj_tag_mc2016.root")

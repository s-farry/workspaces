...
#endif
void fit_roofit_data(){
  
  gROOT->ProcessLine(".x /user2/sfarry/workspaces/WJet/root/lhcbStyle.C");
  TH1::AddDirectory(false);
  
  TFile* f = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_2016.root");
  TFile* g = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_wid_2016.root");
  TFile* h = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_antiiso_2016.root");

  TFile* i = new TFile("/user2/sfarry/workspaces/top/tuples/egm_trk_2016.root");
  TFile* j = new TFile("/user2/sfarry/workspaces/top/tuples/egm_trk_antiiso_2016.root");
  
  TFile* ff = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_2015.root");
  TFile* gg = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_wid_2015.root");
  TFile* hh = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_antiiso_2015.root");

  TFile* ii = new TFile("/user2/sfarry/workspaces/top/tuples/egm_trk_2015.root");
  TFile* jj = new TFile("/user2/sfarry/workspaces/top/tuples/egm_trk_antiiso_2015.root");

  TH1F* etrk_data = (TH1F*)f->Get("tag_pt");
  etrk_data ->Add((TH1F*)ff->Get("tag_pt"));
  TH1F* egm_data  = (TH1F*)i->Get("tag_pt");
  egm_data ->Add((TH1F*)ii->Get("tag_pt"));

  RooRealVar x("PT","p_{T} [GeV]", etrk_data->GetBinLowEdge(1), etrk_data->GetXaxis()->GetBinUpEdge(etrk_data->GetNbinsX() + 1));
  ...
  TLegend* legend = new TLegend(0.65, 0.65, 0.94, 0.9);
  legend->AddEntry(etrk_data, "2015+2016 Data");
  legend->AddEntry(frame->findObject("zee"), "Z#rightarrowee", "F");
  legend->AddEntry(frame->findObject("qcd"), "background", "F");

  frame->Draw();
  legend->Draw("same");
  c1->Print("/user2/sfarry/workspaces/top/figures/etrk_data_fit.pdf");
  ...
  frame2->Draw();
  legend->Draw("same");
  c1->Print("/user2/sfarry/workspaces/top/figures/egm_data_fit.pdf");

...
#endif
void fit_roofit_2015(){
  
  gROOT->ProcessLine(".x /user2/sfarry/workspaces/WJet/root/lhcbStyle.C");
  TH1::AddDirectory(false);
  
  TFile* f = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_2015.root");
  TFile* g = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_wid_2015.root");
  TFile* h = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_antiiso_2015.root");

  TFile* i = new TFile("/user2/sfarry/workspaces/top/tuples/egm_trk_2015.root");
  TFile* j = new TFile("/user2/sfarry/workspaces/top/tuples/egm_trk_antiiso_2015.root");
  ...
  frame->Draw();
  legend->Draw("same");
  c1->Print("/user2/sfarry/workspaces/top/figures/etrk_2015_fit.pdf");
  ...
  frame2->Draw();
  legend->Draw("same");
  c1->Print("/user2/sfarry/workspaces/top/figures/egm_2015_fit.pdf");

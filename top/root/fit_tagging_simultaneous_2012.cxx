...
void fit_tagging_simultaneous_2012(){
  ...
  TH1F* ipchisq_tot  = (TH1F*)f->Get("avipchi2w");
  TH1F* ipchisq_pass = (TH1F*)g->Get("avipchi2w");
  TH1F* ipchisq_fail = (TH1F*)ff->Get("avipchi2w");
  TH1F* ipchisq_b    = (TH1F*)h->Get("avipchi2w");
  TH1F* ipchisq_b_tagged    = (TH1F*)hh->Get("avipchi2w");
  TH1F* ipchisq_c    = (TH1F*)i->Get("avipchi2w");
  TH1F* ipchisq_c_tagged    = (TH1F*)ii->Get("avipchi2w");
  TH1F* ipchisq_l    = (TH1F*)j->Get("avipchi2w");
  TH1F* ipchisq_dl    = (TH1F*)gg->Get("avipchi2w");

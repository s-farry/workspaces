...
#endif
void fit_roofit_2016(){
  
  gROOT->ProcessLine(".x /user2/sfarry/workspaces/WJet/root/lhcbStyle.C");
  TH1::AddDirectory(false);
  
  TFile* f = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_data.root");
  TFile* g = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_wid_data.root");
  TFile* h = new TFile("/user2/sfarry/workspaces/top/tuples/e_trk_antiiso_data.root");

  TFile* i = new TFile("/user2/sfarry/workspaces/top/tuples/egm_trk_2016.root");
  TFile* j = new TFile("/user2/sfarry/workspaces/top/tuples/egm_trk_antiiso_data.root");
  ...
  frame->Draw();
  legend->Draw("same");
  c1->Print("/user2/sfarry/workspaces/top/figures/etrk_2016_fit.pdf");
  ...
  frame2->Draw();
  legend->Draw("same");
  c2->Print("/user2/sfarry/workspaces/top/figures/egm_2016_fit.pdf");

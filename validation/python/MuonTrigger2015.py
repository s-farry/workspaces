...
vtxcut     = TCut("Z0_ENDVERTEX_CHI2/Z0_ENDVERTEX_NDOF < 5")
...
selcut_ptag     = pt + triggercut_plus  + trkqual + eta + vtxcut + after_bugfix # + isocut
selcut_mtag     = pt + triggercut_minus + trkqual + eta + vtxcut + after_bugfix # + isocut
...
def makeMuonTrigger2015(name, selcut, passcut):
    ...
    MuonTrigger2015MagUpMuMinus.AddTree(t)
    ...
    MuonTrigger2015MagUpMuMinus.SetPltRange("Z0_M" , 50 , 60000 , 120000)
    MuonTrigger2015MagUpMuMinus.MakeEntryLists()
    MuonTrigger2015MagUpMuMinus.MakeHists()
    MuonTrigger2015MagUpMuMinus.MakeEfficiencyGraph()
    MuonTrigger2015MagUpMuMinus.SaveToFile()
    
    MuonTrigger2015MagUpMuPlus.AddTree(t)
    ...
    MuonTrigger2015MagUpMuPlus.SetPltRange("Z0_M" , 50 , 60000 , 120000)
    MuonTrigger2015MagUpMuPlus.MakeEntryLists()
    MuonTrigger2015MagUpMuPlus.MakeHists()
    MuonTrigger2015MagUpMuPlus.MakeEfficiencyGraph()
    ...
    MuonTrigger2015MagDownMuMinus.SetPltRange("Z0_M" , 50 , 60000 , 120000)
    MuonTrigger2015MagDownMuMinus.MakeEntryLists()
    MuonTrigger2015MagDownMuMinus.MakeHists()
    MuonTrigger2015MagDownMuMinus.MakeEfficiencyGraph()
    ...
    MuonTrigger2015MagDownMuPlus.SetPltRange("Z0_M" , 50 , 60000 , 120000)
    MuonTrigger2015MagDownMuPlus.MakeEntryLists()
    MuonTrigger2015MagDownMuPlus.MakeHists()
    MuonTrigger2015MagDownMuPlus.MakeEfficiencyGraph()

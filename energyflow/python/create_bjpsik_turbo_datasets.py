...
for aa in [t,u]:
	...
	for i in range(aa.GetEntries()):
		...
		if i%10000 == 0:
			...
			print counters
                ...
                bp0_m        = aa.bp0_dtf_m
                bp0_idx_psi  = aa.bp0_idx_psi
                bp0_idx_trk  = aa.bp0_idx_trk
                psi_idx_trk0 = aa.psi_idx_trk0
                psi_idx_trk1 = aa.psi_idx_trk1
                psi_dls      = aa.psi_dls
	...
	for i in range(aa.GetEntries()):
		...
		bp1_idx_ksp  = aa.bp1_idx_ksp
		bp1_dtf_chi2 = aa.bp1_dtf_chi2
		bp1_ctau     = aa.bp1_ctau
			
		psi_idx_trk0 = aa.psi_idx_trk0
		psi_idx_trk1 = aa.psi_idx_trk1
		psi_dls      = aa.psi_dls
		ksp_idx_trk  = aa.ksp_idx_trk
		ksp_idx_piz  = aa.ksp_idx_piz
		piz_idx_gam0 = aa.piz_idx_gam0
		piz_idx_gam1 = aa.piz_idx_gam1
		...
		for j in range(len(bp1_m)):
			...
			mu1  = get_trk_vars(aa, mu1_idx)
			mu2  = get_trk_vars(aa, mu2_idx)
			gam1 = get_part_vars(aa, 'gam', gam1_idx)
			gam2 = get_part_vars(aa, 'gam', gam2_idx)
			piz  = get_part_vars(aa, 'piz', piz_idx)
			ksp  = get_part_vars(aa, 'ksp', ksp_idx)
...
oFile = TFile("/user2/sfarry/workspaces/energyflow/tuples/bjpsik_data2016_turbo.root", "RECREATE")
ds.Write()
ds2.Write()
hist.Write()
hist2.Write()

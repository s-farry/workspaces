...
bjpsik_mu = TFile("/hepstore/sfarry/Pi0Efficiency/Pi0Efficiency.MC15.MU.12143001.0.160913.00.root")
bjpsik_md = TFile("/hepstore/sfarry/Pi0Efficiency/Pi0Efficiency.MC15.MD.12143001.0.160913.00.root")
bjpsikst_mu = TFile("/hepstore/sfarry/Pi0Efficiency/Pi0Efficiency.MC15.MU.12143401.0.160913.00.root")
bjpsikst_md = TFile("/hepstore/sfarry/Pi0Efficiency/Pi0Efficiency.MC15.MU.12143401.0.160913.00.root")

k_mu_t = bjpsik_mu.Get("data")
k_md_t = bjpsik_md.Get("data")

kst_mu_t = bjpsikst_mu.Get("data")
kst_md_t = bjpsikst_md.Get("data")
...
oFile = TFile("bjpsik_mc2015.root", "RECREATE")
ds.Write()
ds2.Write()
hist.Write()
hist2.Write()

{
  ...
  TFile f("/user2/sfarry/workspaces/energyflow/tuples/bjpsik_data2016_turbo_fit.root");
  TFile g("/user2/sfarry/workspaces/energyflow/tuples/bjpsik_mc2015_fit.root");
  TFile h("/user2/sfarry/workspaces/energyflow/tuples/bjpsikst_data2016_turbo_fit.root");
  TFile i("/user2/sfarry/workspaces/energyflow/tuples/bjpsikst_mc2015_new_fit.root");
  ...
  cout<<"MC B->Jpsi K"<<endl;
  cout<<BjpsiK_mc_Nsig<<" +/- "<<BjpsiK_mc_Nsig_err<<" ( "<<(BjpsiK_mc_Nsig_err / BjpsiK_mc_Nsig)*100.0<<" % )"<<endl;

  
  double BjpsiKst_mc_Nsig = ((TParameter<double>*)i.Get("m2_Nsig_tot"))->GetVal();
  double BjpsiKst_mc_Nsig_fit_err = ((TParameter<double>*)i.Get("m2_Nsig_tot_err"))->GetVal();
  double BjpsiKst_mc_Nsig_poly =  ((TParameter<double>*)i.Get("m2_Nsig_polynomial_tot"))->GetVal();
  double BjpsiKst_mc_Nsig_novo =  ((TParameter<double>*)i.Get("m2_Nsig_novosibirsk_tot"))->GetVal();
  ...
  cout<<"MC: BJpsiK* / BJpsiK ratio"<<endl;
  cout<<"Nominal     Ratio: "<<mc_ratio<<endl;
  cout<<"Poly        Ratio: "<<mc_ratio_poly<<endl;
  cout<<"Novosibirsk Ratio: "<<mc_ratio_novo<<endl;
  ...
  cout<<"BJpsiK* / BJpsiK double ratio"<<endl;
  cout<<"Nominal     Double Ratio: "<<data_ratio/mc_ratio<<endl;
  cout<<"Poly        Double Ratio: "<<data_ratio_poly/mc_ratio_poly<<endl;
  cout<<"Novosibirsk Double Ratio: "<<data_ratio_novo/mc_ratio_novo<<endl;
